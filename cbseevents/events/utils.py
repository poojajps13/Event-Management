...
def get_unique_slug(instance, slugable_field_name_1,slugable_field_name_2,slugable_field_name_3,new_slug=None):
    ...
    while(Klass.objects.filter(slug=new_slug).exists()):
        ...
        return get_unique_slug(instance,slugable_field_name_1=slugable_field_name_1,slugable_field_name_2=slugable_field_name_2,slugable_field_name_3=slugable_field_name_3,new_slug=new_slug)
    return slug
