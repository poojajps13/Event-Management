...
urlpatterns = [
    ...
    path('delete/<slug>',delete_workshop,name='delete_workshop'),
    path('update/<slug>',update_workshop,name='update_workshop'),
    path('update/<slug>',update_save,name='update_save'),
