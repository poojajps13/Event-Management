...
urlpatterns = [
    ...
    path('consolidated-view-all', login_required(consolidated_view), name='consolidated_view_all'),
    path('consolidated-view-c_o_e/<c_o_e>', login_required(consolidated_view), name='consolidated_c_o_e'),
    path('consolidated-view-username/<username>', login_required(consolidated_view), name='consolidated_username'),
]
